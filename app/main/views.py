...
from ..helpers.search_helpers import get_keywords_from_request, get_template_data
...
def search():
    ...
    response = models.search_for_service(keywords=search_keywords, filters=search_filters_obj.get_request_filters())
