...
@dos.route('/buyers/frameworks/<framework_slug>/requirements/user-research-studios', methods=['GET'])
...
@dos.route('/buyers/frameworks/<framework_slug>/requirements/<lot_slug>', methods=['GET'])
