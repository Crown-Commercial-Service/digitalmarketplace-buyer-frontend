...
describe('GOVUK.Analytics', function () {
  ...
  beforeAll(() => {
    ...
    require('../../node_modules/digitalmarketplace-frontend-toolkit/toolkit/javascripts/analytics/_googleAnalyticsUniversalTracker.js')
    require('../../node_modules/digitalmarketplace-frontend-toolkit/toolkit/javascripts/analytics/_govukAnalytics.js')
    require('../../node_modules/digitalmarketplace-frontend-toolkit/toolkit/javascripts/analytics/_register.js')
    require('../../node_modules/digitalmarketplace-frontend-toolkit/toolkit/javascripts/analytics/_trackExternalLinks.js')
    require('../../node_modules/digitalmarketplace-frontend-toolkit/toolkit/javascripts/analytics/_events.js')
    require('../../app/assets/javascripts/analytics/_pageViews.js')
    require('../../app/assets/javascripts/analytics/_buyerSpecificEvents.js')
    require('../../app/assets/javascripts/analytics/_virtualPageViews.js')
    require('../../app/assets/javascripts/analytics/_scrollTracking.js')
    require('../../app/assets/javascripts/analytics/_init.js')
  })
  ...
  xdescribe('Opportunities search page', function () {
    ...
    const setupQueryString = function (queryString) {
  ...
  xdescribe('Opportunity page', function () {
