...
.PHONY: build
build:
	docker build -t digitalmarketplace-aws-buyer-frontend-http --build-arg DM_APP_NAME=buyer-frontend -f docker-aws/Dockerfile.http .
	docker build -t digitalmarketplace-aws-buyer-frontend-wsgi -f docker-aws/Dockerfile.wsgi .
